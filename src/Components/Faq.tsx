...
//                 <h2 className="text-4xl md:text-5xl  text-blue-700 mb-4">Frequently Asked Questions</h2>
...
//                             className="w-full flex justify-between items-center px-6 py-5 text-left text-blue-800 font-medium text-lg focus:outline-none hover:bg-blue-50 transition cursor-pointer"
//                         >
//                             {faq.question}
//                             <FiChevronDown
...
//     visible: { opacity: 1, y: 0, transition: { duration: 0.4, ease: "easeOut" } }, // use a valid string for ease
// };
